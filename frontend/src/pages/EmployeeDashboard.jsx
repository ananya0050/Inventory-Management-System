    ...
    <div style={{ minHeight: '100vh', background: '#f0f2f5' }}>
      ...
      {orderModal.show && orderModal.product && (
        <div style={S.overlay}>
          <div style={{
            ...
            <h5 style={{ fontWeight: 700, marginBottom: '20px' }}>Place Order</h5>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center',
          ...
          <h4 style={{ fontWeight: 700, margin: 0 }}>Products</h4>
...
const S = {
  th:      { padding: '14px 16px', fontWeight: 600, fontSize: '14px', color: '#333' },
